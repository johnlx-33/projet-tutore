...
$\left[0,N-1\right] \rightarrow\mathbb{Z}/ p_{1 \mathbb{Z}} \times  ... \times   \mathbb{Z}/ p_{i \mathbb{Z}} $  \newline
...
$D=\sum_{I\subset \left[n\right]  \newline \left\lvert I\right\rvert=t  } \: \prod _{i \in I} (p_i - 1)$ $\simeq  \binom{n}{t} p^t  $ 
Par exemple si $x=(x_1, x_2, x_3, x_4)$ et $t=2$ alors $D=(p_1-1)(p_2-1)+(p_3-1)(p_4-1)+(p_1-1)(p_3-1)+(p_1-1)(p_4-1)+(p_2-1)(p_3-1)+(p_2-1)(p_4-1)$ \newline
On a donc $\left\lvert recu\right\rvert \simeq \left\lvert B\right\rvert \times D\leq \sum_{i = 1}^{n} p_i  $ \newline
